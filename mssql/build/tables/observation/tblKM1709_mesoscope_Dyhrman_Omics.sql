...
CREATE TABLE [dbo].[tblKM1709_mesoscope_Dyhrman_Omics](
...
CREATE  NONCLUSTERED INDEX [IX_tblKM1709_mesoscope_Dyhrman_Omics_time_lat_lon_depth] ON [dbo].[tblKM1709_mesoscope_Dyhrman_Omics]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC,
