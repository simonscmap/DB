...
CREATE TABLE [dbo].[tblHOE_legacy_3_Caron_Omics](
...
CREATE  NONCLUSTERED INDEX [IX_tblHOE_legacy_3_Caron_Omics_time_lat_lon_depth] ON [dbo].[tblHOE_legacy_3_Caron_Omics]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC,
