...
CREATE TABLE [dbo].[tblHOT273_Caron_Omics](
	[time] [datetime] NOT NULL,
	[lat] [float] NOT NULL,
	[lon] [float] NOT NULL,
	[depth] [float] NOT NULL,
	[sample_name] [nchar](50) NULL,
	[HOT_cruise_number] [smallint] NULL,
...
CREATE  NONCLUSTERED INDEX [IX_tblHOT273_Caron_Omics_time_lat_lon_depth] ON [dbo].[tblHOT273_Caron_Omics]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC,
