...
CREATE TABLE [dbo].[tblDeLong_HOT_metagenomics](
...
CREATE  NONCLUSTERED INDEX [IX_tblDeLong_HOT_metagenomics_time_lat_lon_depth] ON [dbo].[tblDeLong_HOT_metagenomics]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC,
