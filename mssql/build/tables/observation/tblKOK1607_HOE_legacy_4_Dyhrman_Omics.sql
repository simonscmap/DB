...
CREATE TABLE [dbo].[tblKOK1607_HOE_legacy_4_Dyhrman_Omics](
...
CREATE  NONCLUSTERED INDEX [IX_tblKOK1607_HOE_legacy_4_Dyhrman_Omics_time_lat_lon_depth] ON [dbo].[tblKOK1607_HOE_legacy_4_Dyhrman_Omics]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC,
